...
const TABS = [
  ...
  { value: "shipping-options", label: "Shipping options", to: "/fulfilment/shipping-options" },
  {
    value: "shipping-option-types",
    label: "Shipping option types",
    to: "/fulfilment/shipping-option-types",
  },
  { value: "shipping-profiles", label: "Shipping profiles", to: "/fulfilment/shipping-profiles" },
] as const
