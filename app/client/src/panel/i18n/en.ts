...
export const en = {
  ...
  "connect.choosePassword": "Choose a password",
  "connect.choosePasswordWhy":
    "This link works once. After that, sign in with the address it was sent to.",
  "connect.signIn": "Sign in",
  "connect.signInWhy": "An account, or the token the server was started with.",
  "connect.account": "Account",
  "connect.adminToken": "Admin token",
  "connect.password": "Password",
  "connect.again": "Again",
  "connect.tooShort": "At least twelve characters.",
  "connect.doNotMatch": "These two do not match.",
  "connect.setting": "Setting…",
  "connect.setAndSignIn": "Set it and sign in",
  "connect.email": "E-mail",
  "connect.signingIn": "Signing in…",
  "connect.noHostAnswered": "No host answered.",
  "connect.invitationSpent":
    "That invitation has been used already, or it has run out.",
  "connect.wrongPassword": "That e-mail and password do not match an account.",
  "connect.noSelfReset":
    "There is no reset link to ask for: an owner sets a new password for somebody who has lost theirs, and the admin token is the way back in when nobody can.",
  "connect.tokenPlaceholder": "the value of ADMIN_TOKEN",
  "connect.connect": "Connect",
  "connect.tokenWhy":
    "A shared secret, not a person — nothing it changes can be attributed to anybody. Use it to make an account at Operators, then sign in with that. Started with neither a token nor an account and the server serves no admin surface at all.",

  "field.basketId": "Basket ID",
  "field.csv": "CSV",
  "field.row": "Row",
  "field.reason": "Reason",
  "field.reasonOptional": "Reason (optional)",
  "value.noneGiven": "None given.",
  "field.checked": "Checked",
  "field.where": "Where",
  "field.goodFor": "Good for",
  "field.certificate": "Certificate",
  "sort.newest": "Newest first",
  "sort.byEmail": "By e-mail",
  "sort.byTitle": "By title",
  "filter.anyRenewal": "Any renewal",
  "filter.ending": "Ending",
  "filter.renewing": "Renewing",
  "filter.anyCard": "Any card",
  "filter.spendable": "Spendable",
  "filter.stopped": "Stopped",
  "filter.spent": "Spent",
  "search.carts": "Search an e-mail",
  "filter.anyCart": "Any cart",
  "filter.stillOpen": "Still open",
  "filter.ordered": "Became an order",
  "filter.anyPayment": "Any payment",
  "filter.authorized": "Authorized",
  "filter.captured": "Captured",
  "filter.canceled": "Canceled",
  "search.taxRates": "Search a name or code",
  "filter.anyRate": "Any rate",
  "filter.theDefault": "The default",
  "filter.stacking": "Stacks on top",
  "search.priceLists": "Search a title",
  "search.shippingOptions": "Search a name",
  "filter.anyOption": "Any option",
  "filter.outbound": "What a shopper picks",
  "filter.forReturns": "For returns",
  ...
  "action.invite": "Invite somebody",
  "field.runsOut": "Runs out",
  "field.newPassword": "New password",
  "field.downloads": "Downloads",
  "field.granted": "Granted",
  "field.attribute": "Attribute",
  "field.priority": "Priority",
  "frame.priceRules": "What this price applies to",
  "empty.rules": "No rules.",
  "empty.notLookedUp": "Nothing looked up yet.",
  "field.key": "Key",
  "field.valid": "Valid",
  "field.autoGrant": "Auto-grant",
  "field.added": "Added",
  "action.addFile": "Add a file",
  "field.storageKey": "Storage key",
  "field.maxDownloads": "Max downloads",
  "field.validDays": "Valid days",
  "field.rank": "Rank",
  "action.rejectProduct": "Reject this product",
  "field.stock": "Stock",
  "field.who": "Who",
  "field.did": "Did",
  "field.what": "What",
  ...
  "actions.copy": "Copy",
  "action.cancelSubscription": "Cancel this subscription",
  "action.stopNow": "Stop it now instead",
  "field.variant": "Variant",
  "field.unitPrice": "Unit price",
  "field.scheme": "Scheme",
  "field.taxId": "Tax ID",
  "field.home": "Home",
  "field.whichOne": "Which one",
  "field.attempts": "Attempts",
  "field.runAfter": "Run after",
  "field.leaseUntil": "Lease until",
  "frame.payoutLines": "Payout lines by order",
  ...
  "placeholder.priceSetId": "price set id",
  "placeholder.leftOutPreference":
    "left out for the attribute's own preference",
  "placeholder.orderId": "order id",
  "placeholder.productTitle": "Denim jacket",
  "placeholder.draftDefault": "draft (default)",
  "placeholder.keptWithContract": "kept with the contract",
  "placeholder.keyTitle": "Storefront",
  "placeholder.currencyName": "Turkish lira",
  "placeholder.variantId": "variant id",
  "placeholder.unlimited": "unlimited",
  "placeholder.neverExpires": "never expires",
  "placeholder.or": "or…",
  "placeholder.shopsOwn": "left empty, the shop's own",
