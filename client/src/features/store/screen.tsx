...
export function Store({
  regionsAfter,
  onRegionsAfterChange,
  channelsAfter,
  onChannelsAfterChange,
}: {
  regionsAfter: string | undefined
  onRegionsAfterChange: (after: string | undefined) => void
  channelsAfter: string | undefined
  onChannelsAfterChange: (after: string | undefined) => void
}) {
  const regionList = usePagedList(["regions"], "/admin/regions", region, {
    after: regionsAfter,
    onAfterChange: onRegionsAfterChange,
  })
  const channelList = usePagedList(
    ["sales-channels"],
    "/admin/sales-channels",
    salesChannel,
    { after: channelsAfter, onAfterChange: onChannelsAfterChange }
  )
