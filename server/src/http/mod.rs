...
/// needs to fill a shop, a screen's row edited or deleted wherever
/// `tezgah::api` has the function for it, and the reads past what the panel
/// has a screen for yet (`admin::router`'s own doc comment names all five)
