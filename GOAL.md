...
- [ ] an edit grid in the browser — multi-select and a bulk delete are on the
      products list, and the CSV round trip (`/batch`) is what a shop changing
      four hundred prices actually uses
